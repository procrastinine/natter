...
export const CONFIGURATION_COMMANDS = Object.freeze({
  ...
  'chat-preset.create': command([
    'src/store/configuration-domain.ts#createConfigurationApplication.createChatPreset',
  ]),
  ...
  'chat-preset.duplicate': command([
    'src/store/configuration-domain.ts#createConfigurationApplication.duplicateChatPreset',
  ]),

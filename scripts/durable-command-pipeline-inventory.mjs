...
export const CONFIGURATION_COMMAND_PIPELINES = Object.freeze({
  ...
  'chat-preset.create': configurationPipeline('createChatPreset', false),
  ...
  'chat-preset.duplicate': configurationPipeline('duplicateChatPreset', false),
  ...
  'chat-preset.touch': configurationPipeline('touchChatPreset', false),
  'chat-preset.update': configurationPipeline('updateChatPreset'),
  'chat.resolve-model': configurationPipeline('resolveChatModel', false),
  ...
  'global-preference.delete': configurationPipeline('<inline>', false),
  ...
  'pinned-model.clear': configurationPipeline('<inline>', false),
  ...
  'prompt-preset.put': configurationPipeline('putPromptPreset', false),
  'prompt-preset.rename': configurationPipeline('renamePromptPreset'),
  'prompt-preset.touch': configurationPipeline('touchPromptPreset', false),
  'prompt-preset.update': configurationPipeline('updatePromptPreset', false),
  'recent-model.bump': configurationPipeline('bumpRecentModel', false),

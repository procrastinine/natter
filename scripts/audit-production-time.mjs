...
const CLOCK_INVENTORY = {
  ...
  'external-deadline-freshness': {
    ...
    ids: [
      ...
      'src/store/configuration-discovery-coordinator.ts|finish|Date.now|1',
      ...
      'src/store/browser-repo.ts|appendStreamJournalFrames|Date.now|1',
  ...
  'persisted-event-timestamp': {
    ...
    ids: [
      ...
      'src/core/messages.ts|editMessageContentInRepository|Date.now|1',
      ...
      'src/store/attachment-reference-edges.ts|reconcileAttachmentRefCountsForRepair|Date.now|1',
      ...
      'src/store/browser-import-export.ts|replaceMessageAttachmentReferenceOwnersInPages|Date.now|1',
      'src/store/browser-import-export.ts|rewriteAttachmentForImport|Date.now|1',
      'src/store/browser-import-export.ts|rewriteJobForImport|Date.now|1',
...
const RETRY_LOOP_INVENTORY = {
  ...
  'revision-revalidation-loop': {
    ...
    ids: [
      'src/store/browser-configuration-domain.ts|executeRevalidatedConfigurationPlan|ForStatement|unbounded|1',
      'src/store/browser-import-export.ts|importChat|ForStatement|unbounded|1',
      'src/store/browser-import-export.ts|importChatPreset|ForStatement|unbounded|1',
      'src/store/browser-repo.ts|forkChatFromMessage|ForStatement|unbounded|1',
      'src/store/browser-catalog-command-runtime.ts|discardEmptyDraftChats|ForStatement|unbounded|1',
      'src/store/browser-repo.ts|pruneEmptyDraftChats|ForStatement|unbounded|1',
      'src/store/browser-repo.ts|putModelsDiscoveryCacheRow|ForStatement|unbounded|1',
      'src/store/browser-catalog-command-runtime.ts|patchChatMetadataRows|ForStatement|unbounded|1',
      'src/store/browser-catalog-command-runtime.ts|moveChatRowsToFolder|ForStatement|unbounded|1',
      'src/store/browser-catalog-command-runtime.ts|clearCalibrationEverywhere|ForStatement|unbounded|1',
      'src/store/browser-catalog-command-runtime.ts|deleteArchivedChats|ForStatement|unbounded|1',
      'src/store/browser-catalog-command-runtime.ts|ensureFolderAndMoveChats|ForStatement|unbounded|1',
      'src/store/browser-catalog-command-runtime.ts|deleteFolder|ForStatement|unbounded|1',
      'src/store/browser-repo.ts|expandGeneratedOutputVideo|ForStatement|unbounded|1',
      'src/store/configuration-domain.ts|switchChatProfile|ForStatement|unbounded|1',
      'src/store/browser-repo.ts|reconcileStreamJournalIntegrity|ForStatement|unbounded|1',
      'src/store/browser-repo.ts|pruneTerminalStreamJournals|ForStatement|unbounded|1',
    ],
  },
  ...
  'bounded-pagination-scan': {
    ...
    ids: [
      ...
      'src/store/chat-storage-ownership.ts|deleteChatClosure|ForStatement|unbounded|1',
  ...
  'algorithmic-traversal': {
    ...
    ids: [
      ...
      'src/store/stream-journal-storage.ts|appendStreamJournalFrames|ForStatement|bounded|1',
...
const TEMPORAL_INPUT_INVENTORY = {
  ...
  'external-deadline-ttl-lease': {
    ...
    ids: [
      ...
      'src/store/browser-repo.ts|pruneEmptyDraftChats|cutoff|cycle.cutoff|2',
      ...
      'src/store/browser-mutation-runtime.ts|runBrowserMutation|heartbeatAt|now|1',
      ...
      'src/store/configuration-discovery-coordinator.ts|finish|nextRetryAt|Date.now() + discoveryRetryDelay(refresh.failureCount + 1)|1',
